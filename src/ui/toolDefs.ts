...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    description: 'Click a home. Deluge routes to the nearest dry shelter and re-plans as roads flood.',
    hints: ['Click to set the start point'],
  ...
  },
  {
    ...
    key: '9',
    label: 'Shelter',
    description: 'Click to add an evacuation shelter; click one to remove it.',
    hints: ['Click to place', 'Click a shelter to remove'],
  ...
  },
  {
    ...
    key: '0',
    label: 'Probe',
    description: 'Hover to read elevation, water depth and flow speed.',
    hints: ['Hover to measure', 'Drag to orbit'],
    group: 4,
  },
];
