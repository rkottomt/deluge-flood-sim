...
15 images, `submission/gallery/`, all 2400 × 1600 JPEG (3:2), largest 1.3 MB.
...
## 5 · `05-break-the-solver.jpg`

> **"Break it" swaps the robust solver for a textbook explicit one at Courant 1.8 and drops one small splash.**
> Within seconds depth is ∞ or NaN — the magenta speckle — and the HUD reads *Diverged · water created from nothing*.
> "Restore" brings it back.

*Proves:* the stability work is real and demonstrable on demand. Judges can watch the naive version fail.

## 6 · `06-shallow-water-equations.jpg`
...
## 8 · `08-johnstown-conemaugh-valley.jpg`
...
## 10 · `10-houston-harvey-rainfall.jpg`
...
## 11 · `11-nashville-2010-crest.jpg`
...
## 12 · `12-fort-myers-ian-surge.jpg`
...
## 13 · `13-boulder-canyon-flash-flood.jpg`
...
## 14 · `14-ellicott-city-flash-flood.jpg`
...
**Which build each shot came from.** Images 1–7 are the `graphics` branch (3D buildings, new sky, presentation mode).
Images 8–15 are `global-presets` (which is where Asheville, Nashville, Houston, Boulder and Fort Myers actually live —
...
a second Ellicott City frame (superseded by image 14, which has far more water in it) and the Pittsburgh photoreal
